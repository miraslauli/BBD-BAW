...
@products_router.get("/all-admin", response_model=List[ProductResponse], dependencies=[Depends(get_current_admin_user)])
...
@products_router.delete("/categories/admin/{category_id}", dependencies=[Depends(get_current_admin_user)])
