...
class UserCreate(BaseModel):
    ...
    email: EmailStr
    password: str = Field(..., min_length=6, description="Hasło musi mieć co najmniej 6 znaków")
...
class PasswordChange(BaseModel):
    ...
    new_password: str = Field(..., min_length=6, description="Nowe hasło musi mieć co najmniej 6 znaków")
